            ...
            <Table>
                <TableHeader>
                    <TableRow>
                        ...
                        <TableHead>
                            <SortableHeader field="nombre">Usuario</SortableHeader>
                        </TableHead>
                        <TableHead>
                            <SortableHeader field="estado">Estado</SortableHeader>
                        </TableHead>
                        <TableHead>
                            <SortableHeader field="tipoRegistro">Tipo de registro</SortableHeader>
                        </TableHead>
                        <TableHead>
                            <SortableHeader field="rol">Rol</SortableHeader>
                        </TableHead>
                        <TableHead>
                            <SortableHeader field="creadoEn">Creado</SortableHeader>
                        </TableHead>
                        <TableHead>
                            <SortableHeader field="ultimoAcceso">Último acceso</SortableHeader>
                        </TableHead>
                ...
                <TableBody>
                    {users.map((user) => (
                        <TableRow key={user.id} className={selectedUserIds.has(user.id) ? "bg-muted/50" : ""}>
                            ...
                            <TableCell>
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        {user.empleadoId && (
                                            <div className="text-xs text-muted-foreground font-mono">{user.empleadoId}</div>
                                        )}
                                    </div>
                                </div>
                            </TableCell>
                            ...
                            <TableCell>{format(user.creadoEn, "dd MMM yyyy", { locale: es })}</TableCell>
                            <TableCell>
                                {user.ultimoAcceso ? (
                                    format(user.ultimoAcceso, "dd MMM yyyy", { locale: es })
                                ) : (
