...
return (
    <div className="w-full mx-auto p-6 space-y-8">
                                    ...
                                    <div className="relative flex">
                                        ...
                                        >
                                            {status === "completed" ? (
                                                ...
                                                <Icon className={cn("h-6 w-6", status === "current" ? "text-red-600" : "text-gray-400")} />
                                            )}
                                        </div>
                                    </div>
                                ...
                                {stepIndex < EmpresaFormSteps.length - 1 && (
                                    <div
                                        className={cn(
                                            ...
                                            stepIndex < currentStep ? "bg-red-600" : "bg-gray-300"
                                        )}
        ...
        <div className={cn(
            ...
            {nombreEmpresa && (
                <Card className="border-2 border-red-200 dark:border-red-600 bg-gradient-to-br dark:bg-card shadow-lg transition-all duration-500 ease-in-out">
